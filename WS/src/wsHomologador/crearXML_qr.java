...
public class crearXML_qr {
	...
	public static void c_XML(DataHandler dh_det, DataHandler dh_cab, DataHandler dh_aca, DataHandler dh_ley, DataHandler dh_rel, String $FILE_NAME, parametros misParametros) throws Exception  {
...
//	        System.out.println("Nombre del Archivo                      "+$FILE_NAME);
	    ...
	    Firma_Documento_qr.firmar($PATH_SIN_FIRMA,$PATH_CON_FIRMA,$FILE_NAME,misParametros);
				...
				UBLExtension.appendChild(ExtensionContent);
					...
					AdditionalInformation.appendChild(AdditionalMonetaryTotal_DESC);
						...
						AdditionalInformation.appendChild(AdditionalMonetaryTotal);
							...
							PayableAmount_UBL.appendChild(document.createTextNode(""+myCabecera.get_tot_vta_gra()));
		...
		element.appendChild(AccountingSupplierParty);
			...
			AccountingSupplierParty.appendChild(Party3);
				...
				Party3.appendChild(PartyLegalEntity);	
					...
					// cac:PostalAddress
					Element PostalAddress1 = document.createElement("cac:PostalAddress");
					Party3.appendChild(PostalAddress1);	
						
						// cbc:ID
			//			Element id_postal1 = document.createElement("cbc:ID");
			//			id_postal1.appendChild(document.createTextNode($CODIGO_POSTAL));
			//			PostalAddress1.appendChild(id_postal);
						
						// cbc:StreetName
						Element StreetName1 = document.createElement("cbc:StreetName");
						StreetName1.appendChild(document.createTextNode(myCabecera.get_dom_fiscal()));
						PostalAddress1.appendChild(StreetName1);
