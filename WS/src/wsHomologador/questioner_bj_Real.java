...
public class questioner_bj_Real {
	...
	System.out.println("Conector Bajas Ver 2.0");
		
	
	PrintStream console = System.out;
	System.setOut(console);
	System.out.println("Salida a Consola");
		...
		$FILE_NAME_LOGS=_path+_win+"data"+_win+$RUC_INIT+_win+"99_LOGS"+_lin+args[0]+"_1.TXT";
 ...
 //       String _password_usuario_secundario="";
        ...
        if (_os.equals("win")) {
        	_ruta_xmls_sin_firma=_path+_win+"data"+_win+_ruc_param+_win+"02_xmls_sin_firma_real"+_win;
        }
     
        if (_os.equals("linux")) {
        	_ruta_xmls_sin_firma=_path+_lin+"data"+_lin+_ruc_param+_lin+"02_xmls_sin_firma_real"+_lin;
        }
        misParametros.set_ruta_xml_sin_firma(_ruta_xmls_sin_firma);
		
        // armar la ruta para los _ruta_xmls_con_firma
        if (_os.equals("win")) {
        	_ruta_xmls_con_firma=_path+_win+"data"+_win+_ruc_param+_win+"03_xmls_con_firma_real"+_win;
        }
        if (_os.equals("linux")) {
        	_ruta_xmls_con_firma=_path+_lin+"data"+_lin+_ruc_param+_lin+"03_xmls_con_firma_real"+_lin;
        }
        misParametros.set_ruta_xml_con_firma(_ruta_xmls_con_firma);
		
        // armar la ruta para los _ruta_respuestas
        if (_os.equals("win")) {
        	_ruta_respuestas=_path+_win+"data"+_win+_ruc_param+_win+"04_respuestas_real"+_win;
        }
        if (_os.equals("linux")) {
        	_ruta_respuestas=_path+_lin+"data"+_lin+_ruc_param+_lin+"04_respuestas_real"+_lin;
        }
        misParametros.set_ruta_respuestas(_ruta_respuestas);

        // armar _ruta_pdfs
        if (_os.equals("win")) {
        	_ruta_pdfs=_path+_win+"data"+_win+_ruc_param+_win+"05_pdfs_real"+_win;
        }
        if (_os.equals("linux")) {
        	_ruta_pdfs=_path+_lin+"data"+_lin+_ruc_param+_lin+"05_pdfs_real"+_lin;
        }        
        misParametros.set_ruta_pdfs(_ruta_pdfs);
        
        // armar _ruta_tickets
        if (_os.equals("win")) {
        	_ruta_tickets=_path+_win+"data"+_win+_ruc_param+_win+"06_tickets_real"+_win;
        }
        if (_os.equals("linux")) {
        	_ruta_tickets=_path+_lin+"data"+_lin+_ruc_param+_lin+"06_tickets_real"+_lin;
        }        
        misParametros.set_ruta_tickets(_ruta_tickets);
        
        // armar _ruta_respuestas_status
        if (_os.equals("win")) {
        	_ruta_respuestas_status=_path+_win+"data"+_win+_ruc_param+_win+"07_respuestas_status_real"+_win;
        }
        if (_os.equals("linux")) {
        	_ruta_respuestas_status=_path+_lin+"data"+_lin+_ruc_param+_lin+"07_respuestas_status_real"+_lin;
        }        
        misParametros.set_ruta_respuestas_status(_ruta_respuestas_status);

        // armar _ruta_hash
        if (_os.equals("win")) {
        	_ruta_hash=_path+_win+"data"+_win+_ruc_param+_win+"09_hash_real"+_win;
        }
        if (_os.equals("linux")) {
        	_ruta_hash=_path+_lin+"data"+_lin+_ruc_param+_lin+"09_hash_real"+_lin;
        }        
