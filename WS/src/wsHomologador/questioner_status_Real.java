...
public class questioner_status_Real {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("Conector Status del Documento Real Ver 2.0");
		...
		String _win="\\";
	    String _lin="/";
	    $RUC_INIT=args[1].substring(0,11);
 ...
 //       String _password_usuario_secundario="";
		...
		H_main_status.conectar(ticket, null, file_name, misParametros);
