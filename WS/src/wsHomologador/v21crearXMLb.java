...
//		ProfileID.setAttributeNode(attr_schemeURI);
		...
		InvoiceTypeCode.appendChild(document.createTextNode("01"));
...
//			Price_item.appendChild(PriceAmount_Detail);
			...
			PriceAmount_item_reference.appendChild(document.createTextNode(Formato.GranDinero(myDetalle[linea].get_valor_unit())));
...
//				TaxCategory_detalle_Gra_ID.setAttribute("schemeAgencyName", "United Nations Economic Commission for Europe");
		...
		//	TaxExemptionReasonCode.appendChild(document.createTextNode(""));
